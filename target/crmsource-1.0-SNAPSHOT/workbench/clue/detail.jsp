...
<script type="text/javascript">
			...
			$.ajax({
				...
				success:function(data){
					if(data.success){
						...
						showActivityList();
						// 清除选中了的复选框
						$("input[name=commCheck]").prop("checked",false);
						// 清除查询文本框中的内容
						$("#activitySearch").val("");
						// 清除待关联市场活动列表
	...
	function showActivityList(){
        $.ajax({
            url:"workbench/clue/getActivityListById.do",
            data:{
                "clueId":"${c.id}"
            },
            dataType:"json",
    ...
    // 解除关联市场活动，注意：这里的参数id是线索和市场活动关联关系表中的id
    function unbund(id){
		$.ajax({
