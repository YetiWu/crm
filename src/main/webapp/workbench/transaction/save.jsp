...
<script type="text/javascript">
	...
	$(function(){
				...
				$.ajax({
					...
					success:function(data){
						...
						$.each(data,function (i,n) {
							html += '<tr>';
							html += '<td><input type="radio" value="'+n.id+'" name="commCheck"/></td>';
		...
		// 给联系人名称模态窗口中的搜索框加键盘事件
		$("#searchContactsName").keydown(function(event){
			if(event.keyCode == 13){
				$.ajax({
					url:"workbench/transaction/getContactsNameList.do",
					data:{
						"name":$("#searchContactsName").val().trim()
					},
					dataType:"json",
					type:"get",
					success:function(data){
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" style="width: 300px;" id="searchContactsName" placeholder="请输入联系人名称，支持模糊查询">
						    <span class="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
	...
	<form action="workbench/transaction/save.do" class="form-horizontal" id="tranForm" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="openActivitySourceBtn" data-toggle="modal" data-target="#findMarketActivity"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
		...
		<div class="form-group">
			<label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);" id="openContactsNameBtn" data-toggle="modal" data-target="#findContacts"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
