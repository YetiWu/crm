...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#updateRemarkBtn").click(function(){
			var id = $("#remarkId").val();
			$.ajax({
				url:"workbench/activity/updateRemarkContent.do",
				data:{
					"id":id,
					"newContent":$("#noteContent").val().trim()
				},
				dataType:"json",
				type:"post",
				success:function(data){
					if(data.success){
						...
						/*$("#" + id + ">h5").html(data.ar.noteContent);
						$("#" + id + ">small").html(data.ar.editTime + " 由" + data.ar.editBy);*/
